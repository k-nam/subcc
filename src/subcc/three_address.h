...
private:
	...
	ThreeAdressCode(ThreeAdressCode const &);
	ThreeAdressCode &operator=(ThreeAdressCode const &);
...
private:
	// Forbid copy ctor and assignment
	ThreeAdressCodeGenerator(ThreeAdressCodeGenerator const &);
	ThreeAdressCodeGenerator &operator=(ThreeAdressCodeGenerator const &);
