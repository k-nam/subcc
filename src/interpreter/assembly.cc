...
void insertionSort() {
	...
	FP = SP;
	SP = SP - 220;
	LOAD( M0 , STACK , FP + (4) + ZERO , 24 );
	STORE( M0 , STACK , FP + (-24) + ZERO , 24 );
L7:
	*((int *)M0) = 1;
	STORE( M0 , STACK , FP + (-28) + ZERO , 4 );
L8:
L10:
	...
	GOTO (L9);
L11:
	LOAD( M0 , STACK , FP + (-28) + ZERO , 4 );
	STORE( M0 , STACK , FP + (-32) + ZERO , 4 );
L13:
	*((int *)M0) = 0;
	STORE( M0 , STACK , FP + (-44) + ZERO , 4 );
	 GPR0  = 4;
	LOAD( GPR1 , STACK , FP + (-32) + ZERO , 4 );
	 GPR2  =  GPR0 * GPR1 ;
	STORE( GPR2 , STACK , FP + (-76) + ZERO , 4 );
	LOAD( GPR0 , STACK , FP + (-44) + ZERO , 4 );
	LOAD( GPR1 , STACK , FP + (-76) + ZERO , 4 );
	 GPR2  =  GPR0 + GPR1 ;
	STORE( GPR2 , STACK , FP + (-72) + ZERO , 4 );
	LOAD( GPR1 , STACK , FP + (-72) + ZERO , 4 );
	LOAD( GPR0 , STACK , FP + (-24) + GPR1 , 4 );
	STORE( GPR0 , STACK , FP + (-80) + ZERO , 4 );
	LOAD( M0 , STACK , FP + (-80) + ZERO , 4 );
...
L21:
	*((int *)M0) = 0;
	...
	LOAD( GPR0 , STACK , FP + (-136) + ZERO , 4 );
	LOAD( GPR1 , STACK , FP + (-168) + ZERO , 4 );
	 GPR2  =  GPR0 + GPR1 ;
	...
	*((int *)M0) = 0;
	...
	LOAD( GPR0 , STACK , FP + (-176) + ZERO , 4 );
	LOAD( GPR1 , STACK , FP + (-212) + ZERO , 4 );
	 GPR2  =  GPR0 + GPR1 ;
	STORE( GPR2 , STACK , FP + (-208) + ZERO , 4 );
	LOAD( GPR1 , STACK , FP + (-208) + ZERO , 4 );
	LOAD( GPR0 , STACK , FP + (-24) + GPR1 , 4 );
	STORE( GPR0 , STACK , FP + (-216) + ZERO , 4 );
	LOAD( GPR1 , STACK , FP + (-164) + ZERO , 4 );
	LOAD( GPR0 , STACK , FP + (-216) + ZERO , 4 );
...
L23:
	...
	LOAD( M0 , STACK , FP + (-128) + ZERO , 4 );
	STORE( M0 , STACK , FP + (-28) + ZERO , 4 );
L12:
	GOTO (L10);
L9:
	LOAD( M0 , STACK , FP + (-24) + ZERO , 24 );
	SP = FP;
	LOAD ( FP, STACK, SP, 4);
	SP = SP + 4;
	RETURN;
...
L27:
	*((int *)M0) = 0;
	STORE( M0 , STACK , FP + (-292) + ZERO , 4 );
	 ...
	 GPR1  = 0;
	 GPR2  =  GPR0 * GPR1 ;
	STORE( GPR2 , STACK , FP + (-324) + ZERO , 4 );
	LOAD( GPR0 , STACK , FP + (-292) + ZERO , 4 );
	LOAD( GPR1 , STACK , FP + (-324) + ZERO , 4 );
	 GPR2  =  GPR0 + GPR1 ;
	STORE( GPR2 , STACK , FP + (-320) + ZERO , 4 );
	LOAD( GPR1 , STACK , FP + (-320) + ZERO , 4 );
	 GPR0  = 20;
	STORE( GPR0 , STACK , FP + (-288) + GPR1 , 4 );
L28:
	*((int *)M0) = 0;
	STORE( M0 , STACK , FP + (-332) + ZERO , 4 );
	 GPR0  = 4;
	 GPR1  = 1;
	 GPR2  =  GPR0 * GPR1 ;
	STORE( GPR2 , STACK , FP + (-364) + ZERO , 4 );
	LOAD( GPR0 , STACK , FP + (-332) + ZERO , 4 );
	LOAD( GPR1 , STACK , FP + (-364) + ZERO , 4 );
	 GPR2  =  GPR0 + GPR1 ;
	STORE( GPR2 , STACK , FP + (-360) + ZERO , 4 );
	LOAD( GPR1 , STACK , FP + (-360) + ZERO , 4 );
	 GPR0  = 50;
	STORE( GPR0 , STACK , FP + (-288) + GPR1 , 4 );
L29:
	*((int *)M0) = 0;
	STORE( M0 , STACK , FP + (-372) + ZERO , 4 );
	 GPR0  = 4;
	 GPR1  = 2;
	 GPR2  =  GPR0 * GPR1 ;
	STORE( GPR2 , STACK , FP + (-404) + ZERO , 4 );
	LOAD( GPR0 , STACK , FP + (-372) + ZERO , 4 );
	LOAD( GPR1 , STACK , FP + (-404) + ZERO , 4 );
	 GPR2  =  GPR0 + GPR1 ;
	STORE( GPR2 , STACK , FP + (-400) + ZERO , 4 );
	LOAD( GPR1 , STACK , FP + (-400) + ZERO , 4 );
	 GPR0  = 10;
	STORE( GPR0 , STACK , FP + (-288) + GPR1 , 4 );
L30:
	*((int *)M0) = 0;
	STORE( M0 , STACK , FP + (-412) + ZERO , 4 );
	 GPR0  = 4;
	 GPR1  = 3;
	 GPR2  =  GPR0 * GPR1 ;
	STORE( GPR2 , STACK , FP + (-444) + ZERO , 4 );
	LOAD( GPR0 , STACK , FP + (-412) + ZERO , 4 );
	LOAD( GPR1 , STACK , FP + (-444) + ZERO , 4 );
	 GPR2  =  GPR0 + GPR1 ;
	STORE( GPR2 , STACK , FP + (-440) + ZERO , 4 );
	LOAD( GPR1 , STACK , FP + (-440) + ZERO , 4 );
	 GPR0  = 30;
	STORE( GPR0 , STACK , FP + (-288) + GPR1 , 4 );
L31:
	*((int *)M0) = 0;
	STORE( M0 , STACK , FP + (-452) + ZERO , 4 );
	 GPR0  = 4;
	 GPR1  = 4;
	 GPR2  =  GPR0 * GPR1 ;
	STORE( GPR2 , STACK , FP + (-484) + ZERO , 4 );
	LOAD( GPR0 , STACK , FP + (-452) + ZERO , 4 );
...
L37:
	LOAD( GPR0 , STACK , FP + (-24) + ZERO , 4 );
	 GPR1  = 5;
	 GPR2  =  GPR0 < GPR1 ;
	STORE( GPR2 , STACK , FP + (-500) + ZERO , 4 );
	LOAD( GPR0 , STACK , FP + (-500) + ZERO , 4 );
	IF ( GPR0 , L38 );
	GOTO (L36);
L38:
	*((int *)M0) = 0;
	STORE( M0 , STACK , FP + (-504) + ZERO , 4 );
	 GPR0  = 4;
	LOAD( GPR1 , STACK , FP + (-24) + ZERO , 4 );
	 GPR2  =  GPR0 * GPR1 ;
	STORE( GPR2 , STACK , FP + (-536) + ZERO , 4 );
	LOAD( GPR0 , STACK , FP + (-504) + ZERO , 4 );
	LOAD( GPR1 , STACK , FP + (-536) + ZERO , 4 );
	 GPR2  =  GPR0 + GPR1 ;
	STORE( GPR2 , STACK , FP + (-532) + ZERO , 4 );
	LOAD( GPR1 , STACK , FP + (-532) + ZERO , 4 );
	LOAD( GPR0 , STACK , FP + (-288) + GPR1 , 4 );
	STORE( GPR0 , STACK , FP + (-540) + ZERO , 4 );
	LOAD( M0 , STACK , FP + (-540) + ZERO , 4 );
	STORE ( M0, STACK, SP - 4 ,4 );
	SP = SP - 4;
	CALL( printInt);
	SP = SP + 4 ;
...
L41:
	LOAD( GPR0 , STACK , FP + (-24) + ZERO , 4 );
	 GPR1  = 1;
	 GPR2  =  GPR0 + GPR1 ;
	STORE( GPR2 , STACK , FP + (-552) + ZERO , 4 );
	LOAD( M0 , STACK , FP + (-552) + ZERO , 4 );
	STORE( M0 , STACK , FP + (-24) + ZERO , 4 );
L39:
	GOTO (L37);
L36:
...
L43:
	...
	SP = SP + 0 ;
L44:
	LOAD( M0 , STACK , FP + (-288) + ZERO , 24 );
	STORE ( M0, STACK, SP - 24 ,24 );
	SP = SP - 24;
	CALL( insertionSort);
	STORE( M0 , STACK , FP + (-536) + ZERO , 24 );
	SP = SP + 24 ;
	LOAD( M0 , STACK , FP + (-536) + ZERO , 24 );
	STORE( M0 , STACK , FP + (-288) + ZERO , 24 );
L45:
	*((int *)M0) = 0;
	STORE( M0 , STACK , FP + (-24) + ZERO , 4 );
L46:
L47:
	...
	LOAD( GPR0 , STACK , FP + (-540) + ZERO , 4 );
	IF ( GPR0 , L48 );
	GOTO (L24);
L48:
	*((int *)M0) = 0;
	STORE( M0 , STACK , FP + (-544) + ZERO , 4 );
	 GPR0  = 4;
	LOAD( GPR1 , STACK , FP + (-24) + ZERO , 4 );
	 GPR2  =  GPR0 * GPR1 ;
	STORE( GPR2 , STACK , FP + (-576) + ZERO , 4 );
	LOAD( GPR0 , STACK , FP + (-544) + ZERO , 4 );
	LOAD( GPR1 , STACK , FP + (-576) + ZERO , 4 );
	 GPR2  =  GPR0 + GPR1 ;
	STORE( GPR2 , STACK , FP + (-572) + ZERO , 4 );
	LOAD( GPR1 , STACK , FP + (-572) + ZERO , 4 );
	LOAD( GPR0 , STACK , FP + (-288) + GPR1 , 4 );
	STORE( GPR0 , STACK , FP + (-580) + ZERO , 4 );
	LOAD( M0 , STACK , FP + (-580) + ZERO , 4 );
	STORE ( M0, STACK, SP - 4 ,4 );
	SP = SP - 4;
	CALL( printInt);
	SP = SP + 4 ;
...
L51:
	LOAD( GPR0 , STACK , FP + (-24) + ZERO , 4 );
	 GPR1  = 1;
	 GPR2  =  GPR0 + GPR1 ;
	STORE( GPR2 , STACK , FP + (-592) + ZERO , 4 );
	LOAD( M0 , STACK , FP + (-592) + ZERO , 4 );
	STORE( M0 , STACK , FP + (-24) + ZERO , 4 );
L49:
	GOTO (L47);
L24:
